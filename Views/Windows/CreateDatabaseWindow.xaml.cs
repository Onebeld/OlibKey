...
namespace OlibKey.Views.Windows
{
	public class CreateDatabaseWindow : Window
	{
		...
		private void InitializeComponent()
		{
			...
			_tbPassword.GetObservable(TextBox.TextProperty).Subscribe(value => PasswordUtils.DeterminingPasswordComplexity(_pbHard, _tbPassword));
		}
